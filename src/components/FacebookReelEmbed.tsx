...
const FacebookReelEmbed: React.FC<FacebookReelEmbedProps> = ({ videoUrl, className = '' }) => {
  // Instagram Embed
  // Clean URL to just the Reel ID path for embed
  // Input: https://www.instagram.com/reel/DRDWHViDXPS/?utm_source...
  // Output: https://www.instagram.com/reel/DRDWHViDXPS/embed/
  
  // Simple extraction assuming standard IG Reel URL format
  const reelIdMatch = videoUrl.match(/reel\/([A-Za-z0-9_-]+)/);
